        ...
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td class="auto-style7">
                        <asp:RequiredFieldValidator ID="rfvInicioA" runat="server" ControlToValidate="ddFechaInicialA" ErrorMessage="*"></asp:RequiredFieldValidator>
                    </td>
                    ...
                    <td class="auto-style6">
                        <asp:RequiredFieldValidator ID="rfvFinalA" runat="server" ControlToValidate="ddFechaFinalA" ErrorMessage="*"></asp:RequiredFieldValidator>
                    </td>
                    <td>
