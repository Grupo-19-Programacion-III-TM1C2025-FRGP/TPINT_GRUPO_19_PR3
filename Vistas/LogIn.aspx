...
<table align="center" style="margin-top: 20px;">
    <tr>
        <td><asp:Label ID="lblUsuario" runat="server" Text="Usuario:" Font-Bold="True"></asp:Label></td>
        <td><asp:TextBox ID="txtUsuario" runat="server" Width="200px"></asp:TextBox></td>
    </tr>
    <tr>
        <td><asp:Label ID="lblPassword" runat="server" Text="Contraseña:" Font-Bold="True"></asp:Label></td>
