                    ...
                    <table class="auto-style1">
                        ...
                        <tr>
                            ...
                            <td class="auto-style2" colspan="3" rowspan="5">
                                <asp:GridView ID="gvTurnos" runat="server" AutoGenerateEditButton="True" AutoGenerateSelectButton="True" OnRowCancelingEdit="gvTurnos_RowCancelingEdit" OnRowEditing="gvTurnos_RowEditing" OnRowUpdating="gvTurnos_RowUpdating" AllowPaging="True" OnPageIndexChanging="gvTurnos_PageIndexChanging" OnSelectedIndexChanging="gvTurnos_SelectedIndexChanging">
                                </asp:GridView>
                            </td>
